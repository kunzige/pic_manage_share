<template>
	<div :key="$route.fullPath" class="jd">
		<h3 >Image Upload -- OPPO</h3>
		<div class="upload-box" style="margin-top: 10px;">
			...
			<el-button class="upload-file" disabled type="primary" @click="upload" v-if="loading" :loading="loading" >处理中</el-button>
			<div class="data">
				<h2>实时数据</h2>
